...
int _os_datmod (char *name, int off_t, u_int16_t *attr_rev, u_int16_t *type_lang, u_int32_t perm, void **mod, void **mod_head);
...
u_int32_t *id_get_ptr(void *mod, int x, int y, int t);
