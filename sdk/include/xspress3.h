...
#define   XSPRESS3_VERSION_MAJOR        2
#define   XSPRESS3_VERSION_MINOR        1
#define   XSPRESS3_VERSION_PATCH        0
#define   TBS(s)  	#s
#define   XTBS(s)	TBS(s)
const char * const XspLibVers            = XTBS(XSPRESS3_VERSION_MAJOR.XSPRESS3_VERSION_MINOR.XSPRESS3_VERSION_PATCH);
const char * const XspLibMajorVers	 = XTBS(XSPRESS3_VERSION_MAJOR);
const int   XspLibVersNb                 = XSPRESS3_VERSION_MAJOR*10000 + XSPRESS3_VERSION_MINOR*100 + XSPRESS3_VERSION_PATCH;
...
int	xsp3_histogram_udp_close(int path, int card);
...
/**
@}
@defgroup XSP4_ADC_CONTROL   Control bits for Board to Board Aurora Links.
@ingroup XSP3_MACROS
@{
